...
export function createLossRecord({storeId,user,product,reasonCode,quantity,unit='pièce',note='',sourceType='MANUAL',sourceId=null}){
 ...
 audit({storeId,userId:user.id,action:'LOSS_RECORDED',entityType:'LOSS_RECORD',entityId:id,details:{ean:product.ean,reasonCode,quantity:qty,unit,totalRetailValue:total,requiresEvidence,requiresApproval,sourceType,sourceId}});
