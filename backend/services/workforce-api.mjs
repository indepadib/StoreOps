...
import { handleOpeningControlsApi } from './opening-controls-api.mjs';
...
export async function handleWorkforceApi({req,url,user}){
 ...
 const openingControlsResponse=await handleOpeningControlsApi({req,url,user});if(openingControlsResponse)return openingControlsResponse;
