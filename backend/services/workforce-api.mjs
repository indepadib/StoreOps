...
import { handleReadinessApi } from './readiness-api.mjs';
...
export async function handleWorkforceApi({req,url,user}){
 ...
 const readinessResponse=await handleReadinessApi({req,url,user});if(readinessResponse)return readinessResponse;
