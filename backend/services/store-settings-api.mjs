...
import { storeOperationalSettings,saveStoreOperationalSettings,allStoreOperationalSettings } from './store-settings.mjs';
...
export async function handleStoreSettingsApi({req,url,user}){
 ...
 if(path==='/api/admin/stores/settings'&&req.method==='GET'){director(user);return{status:200,data:{items:allStoreOperationalSettings()}}}
