...
const managerInbox=read('backend/services/manager-inbox-batch.mjs');
const d365Config=read('backend/config.mjs');
...
assert.match(receipts,/data-open-receipt/);
assert.match(receipts,/source_created_date/);
assert.match(receipts,/source_vendor_account/);
assert.match(receipts,/Créé le/);
assert.match(receipts,/dernier mois uniquement/);
assert.match(receiving,/hiddenOldPo/);
assert.match(receiving,/source_created_date/);
assert.match(receiving,/PurchaseOrderName/);
assert.match(d365Config,/vendorNameField/);
assert.match(d365Config,/AccountingDate/);
assert.match(stockSignals,/negativePreview/);
assert.match(stockSignals,/hiddenItems/);
assert.match(managerInbox,/stock-negative-summary/);
assert.match(managerInbox,/stock-rupture-summary/);
