...
ok(staff.source==='STOREOPS_PILOT','staffing must stay StoreOps-managed in live D365 mode');
...
ok(cash.source==='STOREOPS_REAL_MASTER','configured Val Fleuri tills must be identified as a real StoreOps master, not a generic pilot fallback');
...
console.log('StoreOps source decoupling + configured cash master tests passed');
