...
assert.match(rescue,/storeops_boot_rescue_v2304/,'boot rescue must guard against reload loops');
...
assert.match(repair,/index\.html\?storeops_clean=2304/,'repair gateway must reopen a fresh index URL');
