...
ok(x.r.status===201&&x.data.status==='APPROVAL_REQUIRED'&&Number(x.data.total_cost_value)>500,'approval loss threshold failed');const high=x.data;
...
console.log('StoreOps loss API cost-valuation integration regression passed');
