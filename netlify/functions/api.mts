...
function bridgeBackendEnvironment(){
  const keys=[
    ...
    'D365_PO_LINE_NUMBER_FIELD','D365_PO_PRODUCT_FIELD','D365_PO_DESCRIPTION_FIELD','D365_PO_BARCODE_FIELD','D365_PO_CATEGORY_FIELD','D365_PO_ORDERED_QTY_FIELD','D365_PO_RECEIVED_QTY_FIELD','D365_PO_REMAINING_QTY_FIELD','D365_PO_LINE_STATUS_FIELD','D365_PO_UNIT_FIELD','D365_PO_LINE_DATE_FIELD','D365_PO_WAREHOUSE_FIELD','D365_PO_PAGE_SIZE','D365_PO_MAX_ROWS','D365_PO_SYNC_TOP','D365_PO_HEADER_ENRICH_LIMIT','D365_PO_SYNC_TIMEOUT_MS',
...
function statelessHealth(request:Request){
  ...
  const response=Response.json({ok:true,service:'StoreOps API',version:envValue('STOREOPS_VERSION')||'2.16.0',authMode:envValue('AUTH_MODE')||'entra',dynamicsMode:envValue('D365_MODE')||'simulated',configurationIssues:[],diagnostics:{source:'NETLIFY_STATELESS_HEALTH'}});
