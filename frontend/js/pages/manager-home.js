...
function pulseCompact(p,loading=false){
 ...
 if(!p||p.status!=='READY'||!p.snapshot)return `<section class="today-pulse today-pulse-hero muted"><div class="today-section-head"><div><span class="today-kicker">BUSINESS PULSE</span><h3>Les ventes ne sont pas encore connectées.</h3></div></div><p>StoreOps n’invente aucun chiffre. Les opérations terrain restent disponibles.</p></section>`;
