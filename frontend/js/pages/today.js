...
import { scheduleCommercialLiveRefresh,scheduleCommercialNetworkRefresh } from '../commercial-live-refresh.js';
...
export async function renderToday(){
  ...
  if(!app.showcase){
    if(isDirector())scheduleCommercialNetworkRefresh({delayMs:220,minIntervalMs:300000,onUpdated:()=>{if(app.page==='today')return renderToday()}});
    else scheduleCommercialLiveRefresh(app.storeId,{delayMs:220,minIntervalMs:300000,onUpdated:()=>{if(app.page==='today')return renderToday()}})
  }
}