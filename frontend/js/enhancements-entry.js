...
const adminEntries={
  ...
  integrations:{section:'integrationsStudioSection',modules:['./admin-studio-integrations.js','./admin-d365-quick-connect.js','./admin-validation-center.js','./admin-d365-mapping.js','./admin-price-history-mapping.js','./admin-loss-export-mapping.js','./admin-taxonomy-mapping.js']},
