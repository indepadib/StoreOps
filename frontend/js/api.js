...
export async function api(path,options={}){
  ...
  const plainObject=body!==null&&typeof body==='object'&&!(body instanceof Blob)&&!(body instanceof FormData)&&!(body instanceof URLSearchParams)&&!(body instanceof ArrayBuffer)&&!ArrayBuffer.isView(body);
  if(plainObject)body=JSON.stringify(body);
