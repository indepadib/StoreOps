...
function css(){
 ...
 .manager-mode .btn,.manager-mode button.manager-action-card,.manager-mode .manager-hub-card{min-height:46px}.manager-mode .btn.brand{font-weight:850}.manager-mode .page.active{padding-bottom:92px}.manager-mode input,.manager-mode select,.manager-mode textarea{font-size:16px}.manager-mode button:focus-visible,.manager-mode input:focus-visible,.manager-mode select:focus-visible,.manager-mode textarea:focus-visible{outline:3px solid rgba(223,35,86,.22);outline-offset:2px}.manager-mode .manager-incident-primary,.manager-mode .manager-alert-primary{min-height:50px}.manager-mode .manager-action-card:active,.manager-mode .manager-hub-card:active,.manager-mode .btn:active{transform:scale(.99)}
 @media(max-width:520px){.guided-hero{padding:15px}.guided-hero h2{font-size:25px}.manager-mode .manager-hub-card,.manager-mode .manager-action-card{padding:14px}.manager-mode .manager-more-grid{gap:9px}}
