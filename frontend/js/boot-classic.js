(function(){
  ...
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',function(){markStarting();setTimeout(function(){renderFailure();},9000);},{once:true});
  else{markStarting();setTimeout(function(){renderFailure();},9000);}
})();