(function(){
  var BUILD='1.85.0';
  var CLEAN_KEY='storeops-legacy-clean-'+BUILD;
  var errors=[];
  ...
  async function cleanLegacyRuntime(){
    try{
      if(window.localStorage&&localStorage.getItem(CLEAN_KEY)==='1')return;
      ...
      try{if(window.localStorage)localStorage.setItem(CLEAN_KEY,'1')}catch(_){}
    }catch(e){remember(e);}
  }
